...
<div className ="container-fluid ">
 ...
 <button className= 'btn btn-default toggleButton'  onClick={this.toggle.bind(this)}><i className= { (this.state.open ? "fas fa-caret-up": "fas fa-caret-down")}></i></button>
 ...
 <div className= "line3"></div></div>
    ...
    <div className="col-lg-6">
            <div className= "col-lg-12">
              ...
              <a  onClick={this.handleShowExecuted}>
          Executed Jobs
        </a>
        &nbsp; &nbsp; &nbsp;
        <a  onClick={this.handleShowPending}>
          Pending Jobs
        </a>
        </div>

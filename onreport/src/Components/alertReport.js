...
class AlertReport extends Component {
    ...
    clickRow(DeviceName){
      ...
      // fetch("http://34.244.151.117:3992/getAlertDevices?subCustCd=" + this.state.selectedSubCustValue +"&&DeviceName="+DeviceName+
...
fetchData(flag,DeviceName,page){
  ...
  axios.post("http://34.244.151.117:3992/getAlertFlag",{body:filterData})
...
clickedOnflag(flag,DeviceName){
  ...
  // // fetch("http://34.244.151.117:3992/getAlertFlag?subCustCd=" + this.state.selectedSubCustValue +"&&DeviceName="+DeviceName+
...
componentDidMount() {
    fetch('http://34.244.151.117:3992/getRegisterSP')
    .then(response => response.json())
    .then(json =>  {
...
getAllDataApi(body){
    axios.post("http://34.244.151.117:3992/getAlert", body)
    // .then(response => response.json())
    .then(json =>  {
      alert(json)
  ...
  //THIS METHOD FOR GET CUSTOMER CODE
      getCustomerApi(SendForSp){
        fetch("http://34.244.151.117:3992/getCustomers?spCode=" + SendForSp)
        .then(response => response.json())
        .then(json =>  {
    ...
    getSubCustomerApi(SendForSp,SendFroCustCD){
        fetch("http://34.244.151.117:3992/getSubCustomers?spCode=" + SendForSp +
  ...
  getAssetsApi(SendForSbCd){
    fetch("http://34.244.151.117:3992/getAssetsBySpCstSubCst?subCustCd=" + SendForSbCd)
         .then(response => response.json())
         .then(json =>  {

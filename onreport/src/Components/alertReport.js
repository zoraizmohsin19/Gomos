...
class AlertReport extends Component {
    ...
    clickRow(DeviceName){
      ...
      // fetch("http://18.203.28.35/getAlertDevices?subCustCd=" + this.state.selectedSubCustValue +"&&DeviceName="+DeviceName+
...
fetchData(flag,DeviceName,page){
  ...
  axios.post("http://18.203.28.35/getAlertFlag",{body:filterData})
...
clickedOnflag(flag,DeviceName){
  ...
  // // fetch("http://18.203.28.35/getAlertFlag?subCustCd=" + this.state.selectedSubCustValue +"&&DeviceName="+DeviceName+
...
getAllDataApi(body){
    axios.post("http://18.203.28.35/getAlert", body)
    // .then(response => response.json())
    .then(json =>  {
      alert(json)
  ...
  //THIS METHOD FOR GET CUSTOMER CODE
      getCustomerApi(SendForSp){
        fetch("http://18.203.28.35/getCustomers?spCode=" + SendForSp)
        .then(response => response.json())
        .then(json =>  {
    ...
    getSubCustomerApi(SendForSp,SendFroCustCD){
        fetch("http://18.203.28.35/getSubCustomers?spCode=" + SendForSp +
  ...
  getAssetsApi(SendForSbCd){
    fetch("http://18.203.28.35/getAssetsBySpCstSubCst?subCustCd=" + SendForSbCd)
         .then(response => response.json())
         .then(json =>  {

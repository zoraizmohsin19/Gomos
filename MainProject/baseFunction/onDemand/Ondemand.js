...
// method for Register Employee Details..
router.post("/registerED", function (req, res, next) {
  ...
  var phone = body.Phone ;
  var email = body.email ;
  var Date_of_joining  = body.Date_of_joining;
  var job_status  = body.job_status;
 
  console.log(job_status);

 var jsonData =  { name, edCd, address, phone, email, Date_of_joining, job_status }
  ...
  MongoClient.connect(
    ...
    function (err, connection) {
      ...
      .insertOne(jsonData, function (err, result) {
        if (err) {
          process.hasUncaughtExceptionCaptureCallback();
        } else {console.log("Entry saved in MsgDump Collection");
        res.json("Data is");
...
router.get("/getRegisterED", function (req, res, next) {
  ...
  MongoClient.connect(
    ...
    //get perticuler sp api by id
router.get("/getRegisterEDbyId", function (req, res, next) {
  var query = url.parse(req.url, true).query;
  console.log(query.id);
  var id = query.id;
  ...
  MongoClient.connect(
    ...
    // this delete sp by id
    router.delete("/delRegisterEDbyId", function (req, res, next) {
      var query = url.parse(req.url, true).query;
      console.log(query.id);
      var id = query.id;
      console.log();
      ...
      //Update perticuler api by id
router.put("/UpdateRegisterEDbyId", function (req, res, next) {
  var query = url.parse(req.url, true).query;
  console.log(query.id);
  var id = query.id;
  ...
  objOfsp = { name, edCd, address, phone, email, Date_of_joining,job_status} 
